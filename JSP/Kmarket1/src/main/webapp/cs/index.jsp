...
<section id="cs">
    <div class="main">
        ...
        <section class="notice">
            <h1>
                공지사항
                <a href="/cs/list.do?cate=${cate}">전체보기</a>
            </h1>
            <ul>
                <li>
                    <a href="/cs/view.do?cate=${cate}" class="title">[안내] 해외결제 사칭 문자 주의</a>
        ...
        <section class="faq">
            <h1>자주 묻는 질문<a href="/cs/list.do?cate=${cate}">전체보기</a></h1>
            <ol>
                <li>
        ...
        <section class="qna">
            <h1>문의하기<a href="/cs/list.do?cate=${cate}">전체보기</a></h1>
            <ul>
                <li>
                    <a href="/cs/view.do?cate=${cate}" class="title">[회원] 개인회원과 법인회원에 차이가 있나요?</a>
                    <p>
