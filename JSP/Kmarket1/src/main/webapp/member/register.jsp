    ...
    <div id="wrapper">
        ...
        <main id="member">
            <div class="register">
                        ...
                        <table>
                            ...
                            <tr class="addr">
                                ...
                                <td>
                                    ...
                                    <div><input type="text" name="km_addr1" id="addr1" placeholder="주소를 검색하세요" readonly></div>
                                    <div><input type="text" name="km_addr2" id="addr2" placeholder="상세주소를 입력하세요"></div>
                                </td>
                            </tr>
                        </table>
                    </section>
                ...
                <img src="../img/user/member_certifi_logo.gif" alt="banner">
            </div>
        </main>
        <footer>
            <ul>
